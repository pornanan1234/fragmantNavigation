...
public class fragment1point2 extends Fragment {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_fragment1point2, container, false);
        nextBtn = view.findViewById(R.id.fragment1point2toNext);
        previousBtn = view.findViewById(R.id.fragment1point2toPrevious);
    ...
    private void setHideFab(){
        ...
        view.findViewById(R.id.fragment1point2toNext).setVisibility(View.VISIBLE);
        view.findViewById(R.id.fragment1point2toPrevious).setVisibility(View.VISIBLE);
    }
    ...
    private void setShowFab(){
        ...
        view.findViewById(R.id.fragment1point2toNext).setVisibility(View.GONE);
        view.findViewById(R.id.fragment1point2toPrevious).setVisibility(View.GONE);
