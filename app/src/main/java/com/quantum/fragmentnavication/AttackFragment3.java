...
public class AttackFragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_attack3, container, false);
        nextBtn = view.findViewById(R.id.Attackfragment3toNext);
        previousBtn = view.findViewById(R.id.Attackfragment3toPrevious);
        ...
        previousBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                replaceFragment(new AttackFragment2());
            }
        });
