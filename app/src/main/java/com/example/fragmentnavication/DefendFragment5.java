...
public class DefendFragment5 extends Fragment {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_defend5, container, false);
        nextBtn = view.findViewById(R.id.Defendragment5toNext);
        previousBtn = view.findViewById(R.id.Defendfragment5toPrevious);
    ...
    private void setHideFab(){
        ...
        mAddFab.shrink();
        view.findViewById(R.id.Defend5text).setVisibility(View.VISIBLE);
    }
    ...
    private void setShowFab(){
        ...
        // parent FAB
        mAddFab.extend();
        view.findViewById(R.id.Defend5text).setVisibility(View.GONE);
