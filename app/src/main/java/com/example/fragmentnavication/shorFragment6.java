...
public class shorFragment6 extends Fragment {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_shor6, container, false);
        nextBtn = view.findViewById(R.id.shorfragment6toNext);
        previousBtn = view.findViewById(R.id.shorfragment6toPrevious);
    ...
    private void setHideFab(){
        ...
        mAddFab.shrink();
        view.findViewById(R.id.shor6text).setVisibility(View.VISIBLE);
    }
    ...
    private void setShowFab(){
        ...
        // parent FAB
        mAddFab.extend();
        view.findViewById(R.id.shor6text).setVisibility(View.GONE);
