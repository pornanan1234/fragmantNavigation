...
public class shorFragment9 extends Fragment {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_shor9, container, false);
        nextBtn = view.findViewById(R.id.shorfragment9toNext);
        previousBtn = view.findViewById(R.id.shorfragment9toPrevious);
        ...
        previousBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                replaceFragment(new shorFragment8());
            }
        });
    ...
    private void setHideFab(){
        ...
        mAddFab.shrink();
        view.findViewById(R.id.shor9text).setVisibility(View.VISIBLE);
    }
    ...
    private void setShowFab(){
        ...
        // parent FAB
        mAddFab.extend();
        view.findViewById(R.id.shor9text).setVisibility(View.GONE);
