...
public class shorFragment2 extends Fragment {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_shor2, container, false);
        nextBtn = view.findViewById(R.id.shorfragment2toNext);
        previousBtn = view.findViewById(R.id.shorfragment2toPrevious);
    ...
    private void setHideFab(){
        ...
        mAddFab.shrink();
        view.findViewById(R.id.shor2text).setVisibility(View.VISIBLE);
    }
    ...
    private void setShowFab(){
        ...
        // parent FAB
        mAddFab.extend();
        view.findViewById(R.id.shor2text).setVisibility(View.GONE);
