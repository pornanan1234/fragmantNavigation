...
public class DefendFragment8 extends Fragment {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_defend8, container, false);
        nextBtn = view.findViewById(R.id.Defendragment8toNext);
        previousBtn = view.findViewById(R.id.Defendfragment8toPrevious);
        ...
        previousBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                replaceFragment(new DefendFragment7());
            }
        });
    ...
    private void setHideFab(){
        ...
        mAddFab.shrink();
        view.findViewById(R.id.Defend8text).setVisibility(View.VISIBLE);
    }
    ...
    private void setShowFab(){
        ...
        // parent FAB
        mAddFab.extend();
        view.findViewById(R.id.Defend8text).setVisibility(View.GONE);
