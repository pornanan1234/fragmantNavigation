...
public class shorFragment5 extends Fragment {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_shor5, container, false);
        nextBtn = view.findViewById(R.id.shorfragment5toNext);
        previousBtn = view.findViewById(R.id.shorfragment5toPrevious);
    ...
    private void setHideFab(){
        ...
        mAddFab.shrink();
        view.findViewById(R.id.shor5text).setVisibility(View.VISIBLE);
    }
    ...
    private void setShowFab(){
        ...
        // parent FAB
        mAddFab.extend();
        view.findViewById(R.id.shor5text).setVisibility(View.GONE);
