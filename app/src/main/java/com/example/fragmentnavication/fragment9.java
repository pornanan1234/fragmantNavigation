...
public class fragment9 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        nextBtn =view.findViewById(R.id.fragment9toNext);
        previousBtn = view.findViewById(R.id.fragment9toPrevious);
    ...
    private void setHideFab(){
        ...
        mAddFab.shrink();
        view.findViewById(R.id.intro9text).setVisibility(View.VISIBLE);
    ...
    private void setShowFab(){
        ...
        // parent FAB
        mAddFab.extend();
        view.findViewById(R.id.intro9text).setVisibility(View.GONE);
