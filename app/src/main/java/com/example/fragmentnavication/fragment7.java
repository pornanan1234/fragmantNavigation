...
public class fragment7 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        nextBtn =view.findViewById(R.id.fragment7toNext);
        previousBtn = view.findViewById(R.id.fragment7toPrevious);
    ...
    private void setHideFab(){
        ...
        mAddFab.shrink();
        view.findViewById(R.id.intro7text).setVisibility(View.VISIBLE);
    ...
    private void setShowFab(){
        ...
        // parent FAB
        mAddFab.extend();
        view.findViewById(R.id.intro7text).setVisibility(View.GONE);
