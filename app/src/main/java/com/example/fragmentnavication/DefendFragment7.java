...
public class DefendFragment7 extends Fragment {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_defend7, container, false);
        nextBtn = view.findViewById(R.id.Defendragment7toNext);
        previousBtn = view.findViewById(R.id.Defendfragment7toPrevious);
        ...
        previousBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                replaceFragment(new DefendFragment6());
            }
        });
    ...
    private void setHideFab(){
        ...
        mAddFab.shrink();
        view.findViewById(R.id.Defend7text).setVisibility(View.VISIBLE);
    }
    ...
    private void setShowFab(){
        ...
        // parent FAB
        mAddFab.extend();
        view.findViewById(R.id.Defend7text).setVisibility(View.GONE);
