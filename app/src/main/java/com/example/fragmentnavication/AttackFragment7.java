...
public class AttackFragment7 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_attack7, container, false);
        nextBtn = view.findViewById(R.id.Attackfragment7toNext);
        previousBtn = view.findViewById(R.id.Attackfragment7toPrevious);
        ...
        previousBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                replaceFragment(new AttackFragment6());
            }
        });
    ...
    private void setHideFab(){
        ...
        mAddFab.shrink();
        view.findViewById(R.id.attack7text).setVisibility(View.VISIBLE);
    ...
    private void setShowFab(){
        ...
        // parent FAB
        mAddFab.extend();
        view.findViewById(R.id.attack7text).setVisibility(View.GONE);
