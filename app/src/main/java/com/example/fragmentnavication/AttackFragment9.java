...
public class AttackFragment9 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_attack9, container, false);
        nextBtn = view.findViewById(R.id.Attackfragment9toNext);
        previousBtn = view.findViewById(R.id.Attackfragment9toPrevious);
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                replaceFragment(new AttackFragment10());
            }
        });
        ...
        previousBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                replaceFragment(new AttackFragment8());
            }
        });
    ...
    private void setHideFab(){
        ...
        mAddFab.shrink();
        view.findViewById(R.id.attack9text).setVisibility(View.VISIBLE);
    ...
    private void setShowFab(){
        ...
        // parent FAB
        mAddFab.extend();
        view.findViewById(R.id.attack9text).setVisibility(View.GONE);
