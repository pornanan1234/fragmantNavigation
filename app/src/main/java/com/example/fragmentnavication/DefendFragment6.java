...
public class DefendFragment6 extends Fragment {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_defend6, container, false);
        nextBtn = view.findViewById(R.id.Defendragment6toNext);
        previousBtn = view.findViewById(R.id.Defendfragment6toPrevious);
    ...
    private void setHideFab(){
        ...
        mAddFab.shrink();
        view.findViewById(R.id.Defend6text).setVisibility(View.VISIBLE);
    }
    ...
    private void setShowFab(){
        ...
        // parent FAB
        mAddFab.extend();
        view.findViewById(R.id.Defend6text).setVisibility(View.GONE);
