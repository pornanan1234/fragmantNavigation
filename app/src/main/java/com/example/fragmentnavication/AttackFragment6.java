...
public class AttackFragment6 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_attack6, container, false);
        nextBtn = view.findViewById(R.id.Attackfragment6toNext);
        previousBtn = view.findViewById(R.id.Attackfragment6toPrevious);
    ...
    private void setHideFab(){
        ...
        mAddFab.shrink();
        view.findViewById(R.id.attack6text).setVisibility(View.VISIBLE);
    ...
    private void setShowFab(){
        ...
        // parent FAB
        mAddFab.extend();
        view.findViewById(R.id.attack6text).setVisibility(View.GONE);
