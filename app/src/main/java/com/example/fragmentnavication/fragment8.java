...
public class fragment8 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        nextBtn =view.findViewById(R.id.fragment8toNext);
        previousBtn = view.findViewById(R.id.fragment8toPrevious);
    ...
    private void setHideFab(){
        ...
        mAddFab.shrink();
        view.findViewById(R.id.intro8text).setVisibility(View.VISIBLE);
    ...
    private void setShowFab(){
        ...
        // parent FAB
        mAddFab.extend();
        view.findViewById(R.id.intro8text).setVisibility(View.GONE);
