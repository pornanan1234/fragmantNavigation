...
public class fragment10 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        nextBtn =view.findViewById(R.id.fragment10toNext);
        previousBtn = view.findViewById(R.id.fragment10toPrevious);
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                replaceFragment(new fragment11());
            }
        });
        previousBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                replaceFragment(new fragment9());
            }
        });
    ...
    private void setHideFab(){
        ...
        mAddFab.shrink();
        view.findViewById(R.id.intro10text).setVisibility(View.VISIBLE);
    ...
    private void setShowFab(){
        ...
        // parent FAB
        mAddFab.extend();
        view.findViewById(R.id.intro10text).setVisibility(View.GONE);
